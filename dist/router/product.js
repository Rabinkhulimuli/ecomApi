...
const userProduct_1 = require("../controller/userProduct");
...
router.route("/product/get-all-category").get(product_1.getAllCategory);
router.route("/upload-product").post(product_1.uploadProduct);
router.route("/product/get-all-product").get(userProduct_1.getAllProduct);
